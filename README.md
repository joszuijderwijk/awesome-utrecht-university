...
- [beamer-uu](https://github.com/joszuijderwijk/beamer-uu) - a Utrecht University template for presentations using LaTeX beamer.
...
- [Virtual Ship](https://github.com/OceanParcels/virtualship) - a simulator allowing students to plan and conduct a virtual research expedition, receiving measurements as if they were coming from actual oceanographic instruments
